...
class MyProfileController extends Controller
{
    ...
    public function personalInformation(Request $request)
    {
        ...
        {           
            return view('user.my-profile.identification-and-employement-details');
        }
    ...
    //   session::forget('education-background');
        return view('user.my-profile.education-background');
    }
    ...
    public function educationBackground(Request $request)
    {
     ...
     {
         return view('user.my-profile.special-information');
     }
     ...
     public function specialInformation(Request $request)
     {
      ...
      {
          return view('user.my-profile.service-interest');
      }
