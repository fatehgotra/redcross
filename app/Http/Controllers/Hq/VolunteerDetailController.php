...
class VolunteerDetailController extends Controller
{
    ...
    public function lodgeInformationForm($id)
    {
        ...
        return view('hq.users.volunteer-details.lodge-information', compact('user', 'lodgement_information'));
    }
    ...
    public function personalInformationForm($id)
    {
        ...
        return view('hq.users.volunteer-details.personal-information', compact('user', 'personal_information'));
    }
    ...
    public function contactInformationForm($id)
    {
        ...
        return view('hq.users.volunteer-details.contact-information', compact('user', 'contact_information'));
    }
    ...
    public function identificationAndEmployementDetailsForm($id)
    {
        ...
        return view('hq.users.volunteer-details.identification-and-employement-details', compact('user', 'identification_details', 'employment_details'));
    }
    ...
    public function educationBackgroundForm($id)
    {
        ...
        return view('hq.users.volunteer-details.education-background', compact('user', 'education_background', 'qualifications', 'skills'));
    }
    ...
    public function specialInformationForm($id)
    {
        ...
        return view('hq.users.volunteer-details.special-information', compact('user', 'special_information', 'blood_information', 'volunteers'));
    }
    ...
    public function serviceInterestForm($id)
    {
        ...
        return view('hq.users.volunteer-details.service-interest', compact('user', 'service_interest'));
    }
    ...
    public function bankingInformationForm($id)
    {
        ...
        return view('hq.users.volunteer-details.banking-information', compact('user', 'personal_banking_information', 'mobile_banking_information'));
    }
    ...
    public function consentsAndChecksForm($id)
    {
        ...
        return view('hq.users.volunteer-details.consents-and-checks', compact('user', 'consents', 'checks', 'referees'));
    }   
