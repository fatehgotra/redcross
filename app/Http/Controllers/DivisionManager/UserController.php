...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('division-manager.users.create', compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('division-manager.suppliers.index')->with('success', 'User added successfully!');
    }
    ...
    public function show(string $id)
    {
        $user            = User::find($id);
        $countries       = Country::get();
        return view('division-manager.users.view', compact('user', 'countries'));
    }
    ...
    public function edit(string $id)
    {
        $user                   = User::find($id);
        $countries              = Country::get();
        return view('division-manager.users.edit', compact('user', 'countries'));
    }
    ...
    public function approvalHistory($id)
    {
        ...
        $user               = User::find($id);
        return view('division-manager.users.approval-history', compact('approval_history', 'user'));
    }
    ...
    public function resetPassword(Request $request){
        ...
        return redirect()->route('division-manager.volunteers.index')->with('success', 'Volunteer password has been reset successfully!');
    }
}
