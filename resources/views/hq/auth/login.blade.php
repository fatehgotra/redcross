                                ...
                                <form action="{{ route('hq.login') }}" method="POST">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <option value="{{ route('division-manager.login') }}">Division Manager</option>
                                         <option value="{{ route('hq.login') }}" selected>HQ</option>
                                    </select>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        <a href="{{ route('hq.password.request') }}" class="text-muted float-end"><small>Forgot your password?</small></a>
