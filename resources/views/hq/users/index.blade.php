                    ...
                    <div class="card-header">
                        {{-- <div class="row">
                            <div class="col-md-12 text-end">
                                <a href="{{ route('hq.volunteers.create') }}" class="btn btn-sm btn-dark float-end">Add
                                    Volunteer</a>
                            </div>
                        </div> --}}
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{ route('hq.volunteer-detail.lodge-information.form', $user->id) }}"
                                                            class="dropdown-item"><i class="mdi mdi-eye"></i>
                                                            Show Details</a> 
                                                            <a href="{{ route('hq.volunteer.approval-history', $user->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $user->id }}'
                                                            action='{{ route('hq.volunteers.destroy', $user->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('hq.volunteer.reset-password') }}">
                        @csrf
