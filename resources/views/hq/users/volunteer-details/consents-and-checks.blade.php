...
<input type='hidden' name='_method' value='PUT'>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link active show" href="{{ route('hq.volunteer-detail.consents-and-checks.form', $user->id) }}">
    ...
    @include('hq.users.volunteer-details.modals.child-protection-policy')
    @include('hq.users.volunteer-details.modals.code-of-conduct')
@endsection
@push('scripts')
    <script>
        @if (count($referees) > 0)
