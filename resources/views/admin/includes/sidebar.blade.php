    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item {{ request()->is('admin/generate-report') || request()->is('admin/generate-report/*') ? 'menuitem-active' : '' }}">
                    <a data-bs-toggle="collapse" href="#report" aria-expanded="false" aria-controls="report"
                        class="side-nav-link">
                ...
                <li class="side-nav-item {{ request()->is('admin/campaigns') || request()->is('admin/campaigns/*') ? 'menuitem-active' : ''  }}">
                    <a data-bs-toggle="collapse" href="#activity" aria-expanded="false" aria-controls="report"
                        class="side-nav-link">
