...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Add Alert</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Add Alert</h4>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.alerts.store') }}" id="supplierForm" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" class="form-control" name="title" id="title"
                                    placeholder="Alert Title" value="{{ old('title') }}">
                                @error('title')
                            ...
                            <div class="col-md-12 mb-2">
                                <label for="description" class="form-label">Alert Description <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control" name="description" id="description" rows="10" placeholder="Alert Description">{{ old('description') }}</textarea>
                                @error('description')
