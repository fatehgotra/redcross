...
@section('title', 'Division Manager')
@section('head')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Division Manager</li>
                        </ol>
                    </div>
                    <h4 class="page-title"><i class="mdi mdi-account-group-outline"></i> Division Manager</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 text-end">
                                <a href="{{ route('admin.division-manager.create') }}" class="btn btn-sm btn-dark float-end">Add
                                    Division Manager</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">                                                        
                                                        ...
                                                        data-id="{{ $user->id }}" data-name="{{ $user->name }}"><i
                                                            ...
                                                            <a href="{{ route('admin.division-manager.edit', $user->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $user->id }}'
                                                            action='{{ route('admin.division-manager.destroy', $user->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('admin.division-manager.reset-password') }}">
                        @csrf
