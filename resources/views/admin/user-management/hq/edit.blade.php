...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Edit HQ</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Edit HQ</h4>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.hq.update', $user->id) }}" id="supplierForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="password" id="password"
                                    ...
                                    <small>Enter only to change HQ password</small>
                                @error('password')
