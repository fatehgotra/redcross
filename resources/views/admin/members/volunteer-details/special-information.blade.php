                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input id="date_first_vaccine" type="text" data-provide="datepicker"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input id="date_second_vaccine" type="text" data-provide="datepicker"
                                    data-date-format="yyyy-mm-dd"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input id="date_booster" type="text" data-provide="datepicker"
                                    data-date-format="yyyy-mm-dd"
