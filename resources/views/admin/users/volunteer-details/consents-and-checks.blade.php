                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" href="{{ route('admin.volunteer-detail.lodge-information.form', $user->id) }}">
                                ...
                                <a class="nav-link active show" href="{{ route('admin.volunteer-detail.consents-and-checks.form', $user->id) }}">
