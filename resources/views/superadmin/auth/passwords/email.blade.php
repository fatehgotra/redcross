...
<head>
    ...
    <meta name="description"
        content="Forgot Password | Superadmin">
    <meta name="keywords"
        content="Superadmin Forgot Password">
                                                ...
                                                <form action="{{ route('superadmin.password.email') }}" method="POST">
                                                    ...
                                                    <div class="row pt-2">
                                                        <div class="col-12 col-md-6 mb-1">
                                                            <a href="{{ route('superadmin.login') }}" class="btn btn-outline-primary btn-block px-0">Go Back to Login</a>
                                                        </div>
                                                        <div class="col-12 col-md-6 mb-1">
