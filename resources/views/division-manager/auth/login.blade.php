...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Log In | Division Manager</title>
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header pt-1 pb-1 text-center bg-dark">
                                <a href="{{ route('division-manager.login') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4">Welcome Division Manager !</p>
                                </div>

                                <form action="{{ route('division-manager.login') }}" method="POST">
                                    @csrf
                                    <div class="mb-2">
                                        ...
                                        <option value="{{ route('division-manager.login') }}" selected>Division Manager</option>
                                    ...
                                    <div class="mb-2">
                                        <a href="{{ route('division-manager.password.request') }}" class="text-muted float-end"><small>Forgot your password?</small></a>
