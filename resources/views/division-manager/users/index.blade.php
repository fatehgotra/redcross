                    ...
                    <div class="card-header">
                        {{-- <div class="row">
                            <div class="col-md-12 text-end">
                                <a href="{{ route('division-manager.volunteers.create') }}" class="btn btn-sm btn-dark float-end">Add
                                    Volunteer</a>
                            </div>
                        </div> --}}
                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <form id='delete-form{{ $user->id }}'
                                                            action='{{ route('division-manager.volunteers.destroy', $user->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('division-manager.volunteer.reset-password') }}">
                        @csrf
