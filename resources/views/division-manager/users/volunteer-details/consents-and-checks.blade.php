...
<input type='hidden' name='_method' value='PUT'>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" href="{{ route('division-manager.volunteer-detail.lodge-information.form', $user->id) }}">
                                ...
                                <a class="nav-link active show" href="{{ route('division-manager.volunteer-detail.consents-and-checks.form', $user->id) }}">
    ...
    @include('division-manager.users.volunteer-details.modals.child-protection-policy')
    @include('division-manager.users.volunteer-details.modals.code-of-conduct')
@include('division-manager.users.volunteer-details.modals.decline-modal')
@endsection
@push('scripts')
    <script>
        @if (count($referees) > 0)
