...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Reset Password| Exhibitor</title>
    ...
    <body>
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header pt-1 pb-1 text-center">
                                <a href="{{ route('login') }}">
                                    <span><img src="{{ asset('assets/images/logo.png') }}" alt="" class="img-fluid" height="150"></span>
                                </a>
                            </div>
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> Copyright © Fiji Red Cross Society 2023.
        </footer>
