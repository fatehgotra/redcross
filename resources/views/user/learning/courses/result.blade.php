                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="w-100 overflow-hidden">
                                <h3 class="mt-0 text-white"><i
                                        class="mdi mdi-bullhorn-outline"></i>&nbsp;Hello&nbsp;&nbsp;{{ Auth::user()->firstname }}
                                    {{ Auth::user()->lastname }}!</h3>
                                <h4 class="m-0 font-weight-normal cta-box-title text-white">Your Test report is ready . . .
                                </h4>
                            </div>
                            <img class="ms-3" src="{{ asset('assets/images/email-campaign.svg') }}" width="120"
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <h3 class="m-0 font-weight-normal cta-box-title"><b>{{ $attempt->course->name }}</b></h3>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="card text-white bg-dark overflow-hidden">
                    <div class="card-body">
                        <div class="toll-free-box text-center text-white">
                            <h4 class="text-white"> <i class="uil-envelope"></i><a
                                    href="mailto:info@redcross.com.fj">info@redcross.com.fj</a></h4>
                        </div>
                    </div> <!-- end card-body-->
                </div>
            </div>
