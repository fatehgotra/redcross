        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link active show" href="{{ route('my-profile.identification-and-employement-details.form') }}">
                            ...
                            <div class="form-group row">                           
                                <div class="col-lg-6">
                                    ...
                                    <select id="photo_id_card_type"
                                        ...
                                        <option value="Drivers License" {{ old('photo_id_card_type', isset($identification_details) ? $identification_details->photo_id_card_type : '') == 'Drivers License' ? 'selected' : '' }}>
                                            Drivers License
                                        </option>
                                        <option value="Passport"
                                            {{ old('photo_id_card_type', isset($identification_details) ? $identification_details->photo_id_card_type : '') == 'Passport' ? 'selected' : '' }}>Passport
                                        </option>
                                        <option value="FNPF-TIN Joint Card" {{ old('photo_id_card_type', isset($identification_details) ? $identification_details->photo_id_card_type : '') == 'FNPF-TIN Joint Card' ? 'selected' : '' }}>
                                            FNPF-TIN Joint Card
                                        </option>
                                        <option value="Student ID" {{ old('photo_id_card_type', isset($identification_details) ? $identification_details->photo_id_card_type : '') == 'Student ID' ? 'selected' : '' }}>Student ID
                                        </option>
                                        <option value="Voter ID" {{ old('photo_id_card_type', isset($identification_details) ? $identification_details->photo_id_card_type : '') == 'Voter ID' ? 'selected' : '' }}>Voter ID
                                        </option>
                                        <option value="Other"
                                            {{ old('photo_id_card_type', isset($identification_details) ? $identification_details->photo_id_card_type : '') == 'Other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="specify_photo_id_card_type" type="text"
                                        ...
                                        name="specify_photo_id_card_type" value="{{ old('specify_photo_id_card_type', isset($identification_details) ? $identification_details->specify_photo_id_card_type : '') }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="id_card_number" type="text"
                                        ...
                                        value="{{ old('id_card_number', isset($identification_details) ? $identification_details->id_card_number : '') }}" autocomplete="id_card_number" placeholder="ID Card Number">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="id_expiry_date" type="date"
                                        ...
                                        value="{{ old('id_expiry_date', isset($identification_details) ? $identification_details->id_expiry_date : '') }}" autocomplete="id_expiry_date" placeholder="ID Card Number">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="tin" type="text"
                                        ...
                                        value="{{ old('tin', isset($identification_details) ? $identification_details->tin : '') }}" autocomplete="tin" placeholder="TIN">
                                    @error('tin')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @isset($identification_details->photo_id)
                                        <a href="{{ asset('storage/uploads/temp/'.$identification_details->photo_id) }}" download="" class="btn btn-warning download-label"><i class="mdi mdi-download"></i></a>
                                    @endisset
                                    </div>
                                    @error('photo_id')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select id="current_employment_status"
                                        ...
                                        <option value="Employed" {{ old('current_employment_status', isset($employment_details) ? $employment_details->current_employment_status : '') == 'Employed' ? 'selected' : '' }}>
                                            Employed
                                        </option>
                                        <option value="Not-Employed"
                                            {{ old('current_employment_status', isset($employment_details) ? $employment_details->current_employment_status : '') == 'Not-Employed' ? 'selected' : '' }}>Not-Employed
                                        </option>
                                        <option value="Student" {{ old('current_employment_status', isset($employment_details) ? $employment_details->current_employment_status : '') == 'Student' ? 'selected' : '' }}>
                                            Student
                                        </option>
                                        <option value="Retired / Pensioner" {{ old('current_employment_status', isset($employment_details) ? $employment_details->current_employment_status : '') == 'Retired / Pensioner' ? 'selected' : '' }}>Retired / Pensioner
                                        </option>
                                        <option value="Self-Employed" {{ old('current_employment_status', isset($employment_details) ? $employment_details->current_employment_status : '') == 'Self-Employed' ? 'selected' : '' }}>Self-Employed
                                        </option>                                    
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="current_occupation" type="text"
                                        ...
                                        name="current_occupation" value="{{ old('current_occupation', isset($employment_details) ? $employment_details->current_occupation : '') }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="organisation_name" type="text"
                                        ...
                                        name="organisation_name" value="{{ old('organisation_name', isset($employment_details) ? $employment_details->organisation_name : '') }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="organisation_address" type="text"
                                        ...
                                        name="organisation_address" value="{{ old('organisation_address', isset($employment_details) ? $employment_details->organisation_address : '') }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="work_contact_number" type="text"
                                        ...
                                        name="work_contact_number" value="{{ old('work_contact_number', isset($employment_details) ? $employment_details->work_contact_number : '') }}"
