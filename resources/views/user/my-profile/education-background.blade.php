...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('my-profile.education-background') }}" method="POST" id="educationBackgroundForm"
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link active show" href="{{ route('my-profile.education-background.form') }}">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                ...
                                @error('highest_level_of_education')
                                    <small id="highest_level_of_education-error"
                                        ...
                                        @else
                                            <tr id="skill-row0">
                                                <td><input type="text" class="form-control form-control-sm"
                                                        name="skill[0][skill]" required></td>
                                                <td><input type="file" class="form-control form-control-sm"
                                                        name="skill[0][evidence]"></td>
                                                <td class="text-end"><button class="btn btn-sm btn-danger"
                                                        onclick="$('#skill-row0').remove();"><i
                                                            class="mdi mdi-delete"></i></button></td>
                                            </tr>
                                        @endif
                ...
                <div class="col-sm-12">
                    <div class="card">
                                        ...
                                        @if (count($qualifications) > 0)
                                            @foreach ($qualifications as $key => $qualification)
                                                <tr id="qualification-row0">
                                                    ...
                                                    <td><input type="file" class="form-control form-control-sm"
                                                            name="qualification[{{ $key }}][evidence]"></td>
                                                    <td><button class="btn btn-sm btn-danger"
                                                            onclick="$('#qualification-row{{ $key }}').remove();"><i
                                                                class="mdi mdi-delete"></i></button></td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr id="qualification-row0">
                                                <td><input type="text" class="form-control form-control-sm"
                                                        name="qualification[0][year]"
                                                        onkeypress="return isNumberKey(event)" maxlength="4" required>
                                                </td>
                                                <td><input type="text" class="form-control form-control-sm"
                                                        name="qualification[0][institution]" required></td>
                                                <td><input type="text" class="form-control form-control-sm"
                                                        name="qualification[0][course]" required></td>
                                                <td>
                                                    <select name="qualification[0][course_status]"
                                                        class="form-select form-control-sm" required>
                                                        <option value="">Select</option>
                                                ...
                                                <td><input type="file" class="form-control form-control-sm"
                                                        name="qualification[0][evidence]"></td>
                                                <td><button class="btn btn-sm btn-danger"
                                                        onclick="$('#qualification-row0').remove();"><i
                                                            class="mdi mdi-delete"></i></button></td>
                                            </tr>
                                        @endif
                                    </tbody>
                        ...
                        <div class="card-footer">
                            <button type="submit" form="educationBackgroundForm"
