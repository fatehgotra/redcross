...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('my-profile.consents-and-checks') }}" method="POST" id="consentAndChecksForm">
            @csrf
            <div class="row">
                <div class="col-sm-3">
                    <div class="card">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="cv_attached"
                                        class="form-select @error('cv_attached') is-invalid @enderror" name="cv_attached">
                                        <option value="">Select</option>
                                        <option value="Yes"
