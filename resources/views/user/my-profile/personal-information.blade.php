        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('my-profile.personal-information') }}" method="POST" id="personalInformationForm">
                            @csrf
                    ...
                    <div class="card-footer">                        
                        <button type="submit" form="personalInformationForm" class="btn btn-sm btn-success float-end">Update</button>
                    </div>
                </div>
            </div>
        </div>   
