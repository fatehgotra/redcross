...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Log In | Branch Level</title>
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header pt-1 pb-1 text-center bg-dark">
                                <a href="{{ route('branch-level.login') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4">Welcome Branch Level !</p>
                                </div>

                                <form action="{{ route('branch-level.login') }}" method="POST">
                                    @csrf
                                    <div class="mb-2">
                                        ...
                                        <option value="{{ route('branch-level.login') }}" selected>Branch Level</option>
                                    ...
                                    <div class="mb-2">
                                        <a href="{{ route('branch-level.password.request') }}" class="text-muted float-end"><small>Forgot your password?</small></a>
