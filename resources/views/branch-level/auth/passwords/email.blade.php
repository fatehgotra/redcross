...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Reset Password| Branch Level</title>
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('branch-level.password.email') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="{{ route('branch-level.login') }}" class="text-muted ml-1"><b>Log In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                    </div> <!-- end col -->
                </div>
