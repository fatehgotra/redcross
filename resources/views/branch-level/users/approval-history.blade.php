...
@section('title', "Volunteer | Approval History")
@section('head')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">                            
                            <li class="breadcrumb-item"><a href="{{ url('/branch-level') }}">Dashboard</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="timeline-alt pb-0">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-item-info">
                                    <a href="#" class="text-info fw-bold mb-1 d-block">Volunteer Application submitted
