...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('branch-level.volunteers.index') }}">Volunteers</a></li>
                            <li class="breadcrumb-item active">Add Volunteer</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Add Volunteer</h4>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('branch-level.volunteers.store') }}" id="supplierForm" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2 text-end">
                                ...
                                <a href="{{ route('branch-level.volunteers.index') }}" class="btn btn-sm btn-dark">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
