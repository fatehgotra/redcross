        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"><i class="mdi mdi-account-group-outline"></i> Volunteers</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        {{-- <div class="row">
                            <div class="col-md-12 text-end">
                                <a href="{{ route('branch-level.volunteers.create') }}" class="btn btn-sm btn-dark float-end">Add
                                    Volunteer</a>
                            </div>
                        </div> --}}
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{ route('branch-level.volunteer-detail.lodge-information.form', $user->id) }}"
                                                            class="dropdown-item"><i class="mdi mdi-eye"></i>
                                                            Show Details</a> 
                                                            <a href="{{ route('branch-level.volunteer.approval-history', $user->id) }}"
                                                        ...
                                                        <form id='delete-form{{ $user->id }}'
                                                            action='{{ route('branch-level.volunteers.destroy', $user->id) }}'
                                                            method='POST'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="changePasswordForm" action="{{ route('branch-level.volunteer.reset-password') }}">
                        @csrf
