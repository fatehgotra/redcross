                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.lodge-information.form', $user->id) }}">
                                    <i class="me-1 dripicons-chevron-right"></i>Lodgement Information
                                </a>
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.personal-information.form', $user->id) }}">
                                    <i class="me-1 dripicons-chevron-right"></i>Personal Information
                                </a>
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.contact-information.form', $user->id) }}">
                                ...
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.education-background.form', $user->id) }}">
                                    <i class="me-1 dripicons-chevron-right"></i>Education Background
                                </a>
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.special-information.form', $user->id) }}">
                                    <i class="me-1 dripicons-chevron-right"></i>Special Information
                                </a>
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.service-interest.form', $user->id) }}">
                                    <i class="me-1 dripicons-chevron-right"></i>Service Interests
                                </a>
                                <a class="nav-link" href="{{ route('branch-level.volunteer-detail.banking-information.form', $user->id) }}">
                                    <i class="me-1 dripicons-chevron-right"></i>Banking Information
                                </a>
                                <a class="nav-link active show" href="{{ route('branch-level.volunteer-detail.consents-and-checks.form', $user->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="cv_attached"
                                        class="form-select @error('cv_attached') is-invalid @enderror" name="cv_attached" disabled>
                                        <option value="">Select</option>
                                        <option value="Yes"
                                            {{ old('cv_attached', isset($checks) ? $checks->cv_attached : '') == 'Yes' ? 'selected' : '' }}>
                                            Yes
                                        </option>
                                        <option value="No"
                                            {{ old('cv_attached', isset($checks) ? $checks->cv_attached : '') == 'No' ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </select>
                                    @error('cv_attached')
