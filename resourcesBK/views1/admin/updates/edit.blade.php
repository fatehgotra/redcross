...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Update</h4>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.updates.update', $update->id) }}" id="supplierForm"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" class="form-control" name="title" id="title"
                                    placeholder="Update / News Title" value="{{ old('title', $update->title) }}">
                                @error('title')
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea class="form-control" name="content" id="content" rows="10" placeholder="Content">{{ old('content', $update->content) }}</textarea>
                                @error('content')
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select name="status" id="statuses" class="form-select">
                                    ...
                                    <option value="0" {{ old('status', $update->status) == 0 ? 'selected' : '' }}>Draft
                                    </option>
                                    <option value="1" {{ old('status', $update->status) == 1 ? 'selected' : '' }}>
                                        Published</option>
                                </select>
                                @error('status')
