                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <label for="registration_location_type" class="col-form-label">Nearest Branch <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-12">
                                ...
                                <select id="role" class="form-select @error('role') is-invalid @enderror"
                                    ...
                                    <option value="volunteer"
                                        {{ old('role', isset($user) ? $user->role : '') == 'volunteer' ? 'selected' : '' }}>
                                        Volunteer
                                    </option>
                                    <option value="member"
                                        {{ old('role', isset($user) ? $user->role : '') == 'member' ? 'selected' : '' }}>
                                        Member
                                    </option>
                                    <option value="both"
                                        {{ old('role', isset($user) ? $user->role : '') == 'both' ? 'selected' : '' }}>
                                        Both
                                    </option>
                                </select>
                                @error('role')
