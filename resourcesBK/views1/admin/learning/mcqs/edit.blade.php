...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit MCQ</h4>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.mcqs.update', $question->id) }}" id="questionForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_1" id="option_1"
                                    placeholder="Option 1" rows="3">{{ old('option_1', $question->option_1) }}</textarea>
                                @error('option_1')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_2" id="option_2"
                                    placeholder="Option 2" rows="3">{{ old('option_2', $question->option_2) }}</textarea>
                                @error('option_2')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_3" id="option_3"
                                    placeholder="Option 3" rows="3">{{ old('option_3', $question->option_3) }}</textarea>
                                @error('option_3')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="option_4" id="option_4"
                                    placeholder="Option 4" rows="3">{{ old('option_4', $question->option_4) }}</textarea>
                                @error('option_4')
                            ...
                            <div class="col-md-12 mb-2 text-end">
                                <button type="submit" class="btn btn-sm btn-warning" form="questionForm">Update</button>
