        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active show" href="{{ route('my-profile.personal-information.form') }}">
            ...
            <div class="col-sm-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('my-profile.personal-information') }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="lastname" type="text"
                                        ...
                                        autocomplete="lastname" placeholder="Lastname" autofocus>
                                    @error('lastname')
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="other_names" type="text"
                                        ...
                                        autocomplete="other_names" placeholder="Other Name(s)">
                                    @error('other_names')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="citizenship"
                                        class="form-select @error('citizenship') is-invalid @enderror" name="citizenship">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="ethnic_background"
                                        ...
                                        data-placeholder="Select Ethnic Background" multiple>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="specify_ethnic_background" type="text"
                                        ...
                                        placeholder="Specify Ethnic Background (If any other)">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input id="no_of_dependents" type="number" min="0"
                                        ...
                                        autocomplete="no_of_dependents" placeholder="Number of Dependents">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="languages_spoken"
                                        ...
                                        data-placeholder="Select Language(s) Spoken" multiple>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="specify_languages_spoken" type="text"
                                        ...
                                        placeholder="Specify Language(s) Spoken (If any other)">
                    ...
                    <div class="card-footer">
                        <button type="submit" form="personalInformationForm"
