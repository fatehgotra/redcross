...
use App\Http\Controllers\BranchLevel\Auth\ChangePasswordController;
use App\Http\Controllers\BranchLevel\Auth\ForgotPasswordController;
use App\Http\Controllers\BranchLevel\Auth\LoginController;
use App\Http\Controllers\BranchLevel\Auth\MyAccountController;
use App\Http\Controllers\BranchLevel\Auth\ResetPasswordController;
use App\Http\Controllers\BranchLevel\DashboardController;
use App\Http\Controllers\BranchLevel\UserController;
use App\Http\Controllers\BranchLevel\VolunteerDetailController;
...
Route::group(['prefix' => 'branch-level', 'as' => 'branch-level.'], function () {
