...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    */
    ...
    Route::put('suppliers-change-status/{id}', [SupplierController::class, 'changeStatus'])->name('suppliers.change-status');

    Route::get('supplier-impersonate/{user}', [SupplierController::class, 'impersonate'])->name('suppliers.impersonate');
